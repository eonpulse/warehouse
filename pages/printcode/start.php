...
/*
include('/system/php-barcode.php');
...
$this->inf .= "
  <form action='' method='post'>
    <p><textarea rows='10' cols='45' name='list'></textarea></p>
...
foreach ($codelist as $str) {
    
    $code = $code128->getCode($str);
    $this->inf .= "<div class='barcode'>$str".$code."</div>";

//$this->inf .= "<div class='barcode'>111".Barcode128::getCode('111')."</div><br>";
//$this->inf .= "<div class='barcode'>222".Barcode128::getCode('222')."</div><br>";
